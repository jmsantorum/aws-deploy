...
class SlackNotification(Notification):
    ...
    def notify_start(self, cluster, tag, task_definition, comment, user, service=None, rule=None):
        if not self.__url or not self.__service_match_re.search(service or rule) or not self.__username:
            return
        ...
        payload = self._get_payload('Deployment has started', messages)
    ...
    def notify_success(self, cluster, revision, service=None, rule=None):
        ...
        payload = self._get_payload('Deployment finished successfully', messages, 'good')
    ...
    def notify_failure(self, cluster, error, service=None, rule=None):
        ...
        payload = self._get_payload('Deployment failed', messages, 'danger')
